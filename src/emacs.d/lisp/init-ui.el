...
(use-package catppuccin-theme
  ...
  (ch/define-theme-faces-customization
   ...
   `(epa-validity-high ((t (:foreground ,(catppuccin-color 'green)))))
   `(epa-validity-medium ((t (:foreground ,(catppuccin-color 'yellow) :slant normal))))
   `(epa-validity-disabled ((t (:foreground ,(catppuccin-color 'red) :inverse-video nil))))
   `(mode-line-emphasis ((t (:foreground ,(catppuccin-color 'sky)))))
   `(vertico-current ((t (:foreground ,(catppuccin-color 'green) :background ,(catppuccin-lighten (catppuccin-color 'base) 17) :extend: t))))
   ...
   `(font-latex-sectioning-5-face ((t (:inherit 'variable-pitch :foreground ,(catppuccin-color 'maroon) :weight bold))))
   ...
   `(markdown-code-face ((t (:background ,(catppuccin-lighten (catppuccin-color 'base) 17) :extend t))))
   ...
   `(message-header-cc ((t (:foreground ,(catppuccin-color 'maroon) :weight bold))))
   ...
   `(org-hide ((t (:foreground ,(catppuccin-color 'base)))))
   `(org-list-dt ((t (:foreground ,(catppuccin-color 'mauve) :weight bold))))
   ...
   `(org-habit-alert-face ((t (:background ,(catppuccin-color 'pink) :foreground ,(catppuccin-color 'surface0)))))
