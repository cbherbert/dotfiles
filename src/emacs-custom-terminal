...
(custom-set-variables
 ...
 '(package-selected-packages
   '(snakemake-mode color-theme-solarized yasnippet yaml-mode which-key use-package tuareg try swiper python-mode pydoc matlab-mode markdown-mode magit lua-mode flycheck-aspell ein doom-themes doom-modeline diredful cuda-mode csv-mode chronos auctex alert)))
(custom-set-faces
 ...
 '(alert-high-face ((t (:foreground "red"))))
 '(alert-low-face ((t (:foreground "green"))))
 '(alert-moderate-face ((t (:foreground "yellow"))))
 '(bookmark-menu-bookmark ((t (:foreground "brightmagenta"))))
 ...
 '(epa-validity-disabled ((t (:foreground "brightred"))))
 '(epa-validity-high ((t (:foreground "green"))))
 '(epa-validity-low ((t (:foreground "yellow"))))
 '(epa-validity-medium ((t (:foreground "blue"))))
 '(font-latex-math-face ((t (:foreground "brightmagenta"))))
 ...
 '(org-agenda-clocking ((t (:inherit secondary-selection :background "white"))))
 ...
 '(org-column ((t (:foreground "white" :inverse-video t))))
 '(org-column-title ((t (:background "white" :foreground "green" :inverse-video t :weight bold))))
