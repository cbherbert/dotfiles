...
BEGIN {
    ...
    author = ENVIRON["AUTHOR"] != "" ? ENVIRON["AUTHOR"] : "Corentin Herbert"

    # and to your email address
    emailaddress = ENVIRON["EMAIL"] != "" ? ENVIRON["EMAIL"] : "corentin.herbert@ens-lyon.fr"

    # main title of the Org file
    title = ENVIRON["TITLE"] != "" ? ENVIRON["TITLE"] : ""

    # calendar/category name for display in org-mode
    calendarname = ENVIRON["CALENDAR"] != "" ? ENVIRON["CALENDAR"] : "seminars"
